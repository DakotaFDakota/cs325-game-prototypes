export default class ApproachRaccoonsScene extends Phaser.Scene{
    ...
    create(){
        this.titletext = this.add.text(50,150,"The raccoons are startled and ", {font: "20px Courier"});
        ...
        this.option1.on('pointerdown', () => this.scene.start("SnackScene", {cb: this.crowbar,   num: this.numplayers, playname1: this.player1, playname2: this.player2, playname3: this.player3, playname4: this.player4, player1h: this.player1health,player2h: this.player2health, player3h: this.player3health, player4h: this.player4health}));
